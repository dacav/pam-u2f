...
// Open the given path, checking the file and its ancestors for security.
//
// We want to ensure the following properties:
// - The path starts with '/' and does not end with '/';
// - All components of the path are owned by root, and no directories are group
//   or world writable;
